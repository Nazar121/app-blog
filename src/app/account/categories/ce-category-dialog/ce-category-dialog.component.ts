...
@Component({
  selector: 'app-ce-category-dialog',
  templateUrl: './ce-category-dialog.component.html',
  styleUrls: ['./ce-category-dialog.component.scss']
})
export class CECategoryDialogComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<CECategoryDialogComponent>,
